...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{\uncurry{\uncurry{\Conid{Bop}}}\comp (\Varid{swap}\times\Varid{id})\comp \Varid{assocl}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outExpr}\mathbin{::}\Conid{Expr}\to \Conid{Int}+(\Conid{Op},(\Conid{Expr},\Conid{Expr})){}\<[E]%
\\
\>[B]{}\Varid{outExpr}\;(\Conid{Num}\;\Varid{a}){}\<[23]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{anaExpr}\;\Varid{f}\mathrel{=}\Varid{inExpr}\comp (\Varid{recExpr}\;(\Varid{anaExpr}\;\Varid{f}))\comp \Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloExpr}\;\Varid{a}\;\Varid{c}\mathrel{=}\Varid{cataExpr}\;\Varid{a}\comp \Varid{anaExpr}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcula}\mathbin{::}\Conid{Expr}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{calcula}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{aux}}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{aux}\mathbin{::}(\Conid{Op},(\Conid{Int},\Conid{Int}))\to \Conid{Int}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{aux}\;(\Varid{o},(\Varid{int1},\Varid{int2}))\mathrel{=}{}\<[35]%
\>[35]{}\Varid{calculaOP}\;\Varid{o}\;\Varid{int1}\;\Varid{int2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calculaOP}\mathbin{::}\Conid{Op}\to \Conid{Int}\to \Conid{Int}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{calculaOP}\;(\Conid{Op}\;\text{\tt \char34 +\char34})\;\Varid{int1}\;\Varid{int2}\mathrel{=}(\mathbin{+})\;\Varid{int1}\;\Varid{int2}{}\<[E]%
\\
\>[B]{}\Varid{calculaOP}\;(\Conid{Op}\;\text{\tt \char34 -\char34})\;\Varid{int1}\;\Varid{int2}\mathrel{=}(\mathbin{-})\;\Varid{int1}\;\Varid{int2}{}\<[E]%
\\
\>[B]{}\Varid{calculaOP}\;(\Conid{Op}\;\text{\tt \char34 *\char34})\;\Varid{int1}\;\Varid{int2}\mathrel{=}(\mathbin{*})\;\Varid{int1}\;\Varid{int2}{}\<[E]%
\\
\>[B]{}\Varid{calculaOP}\;(\Conid{Op}\;\text{\tt \char34 /\char34})\;\Varid{int1}\;\Varid{int2}\mathrel{=}\Varid{int1}\div \Varid{int2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{show'}\mathbin{::}\Conid{Expr}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{show'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{showAux}}{\Varid{auxShow}}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{auxShow}\mathbin{::}(\Conid{Op},(\Conid{String},\Conid{String}))\to \Conid{String}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{auxShow}\;(\Varid{o},(\Varid{s1},\Varid{s2}))\mathrel{=}\Varid{calculaString}\;\Varid{o}\;\Varid{s1}\;\Varid{s2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{showAux}\mathbin{::}\Conid{Int}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{showAux}\;\Varid{a}\mathrel{=}\mathbf{if}\;\Varid{a}\geq \mathrm{0}\;\mathbf{then}\;\Varid{show}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{else}\;\text{\tt \char34 (\char34}\plus \Varid{show}\;\Varid{a}\plus \text{\tt \char34 )\char34}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calculaString}\mathbin{::}\Conid{Op}\to \Conid{String}\to \Conid{String}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{calculaString}\;(\Conid{Op}\;\text{\tt \char34 +\char34})\;\Varid{s1}\;\Varid{s2}\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \text{\tt \char34 +\char34}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
\\
\>[B]{}\Varid{calculaString}\;(\Conid{Op}\;\text{\tt \char34 -\char34})\;\Varid{s1}\;\Varid{s2}\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \text{\tt \char34 -\char34}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
\\
\>[B]{}\Varid{calculaString}\;(\Conid{Op}\;\text{\tt \char34 *\char34})\;\Varid{s1}\;\Varid{s2}\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \text{\tt \char34 *\char34}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
...
\\
\>[B]{}\Varid{compile}\mathrel{=}\Varid{hyloExpr}\;\Varid{conquer}\;\Varid{divide}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divide}\mathbin{::}\Conid{String}\to \Conid{Int}+(\Conid{Op},(\Conid{String},\Conid{String})){}\<[E]%
\\
\>[B]{}\Varid{divide}\;\Varid{s}\mathrel{=}\mathbf{if}\;(\length \;\Varid{s})\equiv \mathrm{1}\;\mathbf{then}\;i_1\;(\Varid{read}\;\Varid{s}\mathbin{::}\Conid{Int}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{else}\;i_2\;(\Varid{testaExpr}\;\Varid{s}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{testaExpr}\mathbin{::}\Conid{String}\to (\Conid{Op},(\Conid{String},\Conid{String})){}\<[E]%
\\
\>[B]{}\Varid{testaExpr}\;\Varid{x}\mathrel{=}\mathbf{if}\;\Varid{isNothing}\;\Varid{res}\;\mathbf{then}\;(\Varid{id}\times(\Varid{filterParenteses}\times\Varid{filterParenteses}))\mathbin{\$}\Varid{aux}\mathbin{\$}\Varid{span}\;(\lambda \Varid{x}\to \Varid{x}\not\equiv \text{\tt '+'}\mathrel{\wedge}\Varid{x}\not\equiv \text{\tt '-'}\mathrel{\wedge}\Varid{x}\not\equiv \text{\tt '*'}\mathrel{\wedge}\Varid{x}\not\equiv \text{\tt '/'})\;\Varid{x}\;\mathbf{else}\;\Varid{fromJust}\;\Varid{res}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{res}\mathrel{=}\Varid{testaPadrao}\;(\Varid{x},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{aux}\;(\Varid{a},\Varid{b})\mathrel{=}(\Conid{Op}\;[\mskip1.5mu \Varid{head}\;\Varid{b}\mskip1.5mu],(\Varid{a},\Varid{tail}\;\Varid{b})){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{filterParenteses}\mathrel{=}\Varid{filter}\;(\lambda \Varid{x}\to \Varid{x}\not\equiv \text{\tt '('}\mathrel{\wedge}\Varid{x}\not\equiv \text{\tt ')'}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{testaPadrao}\mathbin{::}(\Conid{String},\Conid{String})\to \Conid{Maybe}\;(\Conid{Op},(\Conid{String},\Conid{String})){}\<[E]%
\\
\>[B]{}\Varid{testaPadrao}\;([\mskip1.5mu \mskip1.5mu],\anonymous )\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[B]{}\Varid{testaPadrao}\;([\mskip1.5mu \Varid{x}\mskip1.5mu],\anonymous )\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[B]{}\Varid{testaPadrao}\;((\Varid{c1}\mathbin{:}\Varid{c2}\mathbin{:}\Varid{s}),\Varid{a1})\mid \Varid{c1}\equiv \text{\tt ')'}\mathrel{\wedge}\Varid{c2}\equiv \text{\tt '*'}\mathrel{=}\Conid{Just}\;(\Conid{Op}\;\text{\tt \char34 *\char34},((\Varid{a1}\plus [\mskip1.5mu \Varid{c1}\mskip1.5mu]),\Varid{s})){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mid \Varid{c1}\equiv \text{\tt ')'}\mathrel{\wedge}\Varid{c2}\equiv \text{\tt '+'}\mathrel{=}\Conid{Just}\;(\Conid{Op}\;\text{\tt \char34 +\char34},((\Varid{a1}\plus [\mskip1.5mu \Varid{c1}\mskip1.5mu]),\Varid{s})){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mid \Varid{c1}\equiv \text{\tt ')'}\mathrel{\wedge}\Varid{c2}\equiv \text{\tt '-'}\mathrel{=}\Conid{Just}\;(\Conid{Op}\;\text{\tt \char34 -\char34},((\Varid{a1}\plus [\mskip1.5mu \Varid{c1}\mskip1.5mu]),\Varid{s})){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mid \Varid{c1}\equiv \text{\tt '*'}\mathrel{\wedge}\Varid{c2}\equiv \text{\tt '('}\mathrel{=}\Conid{Just}\;(\Conid{Op}\;\text{\tt \char34 *\char34},(\Varid{a1},[\mskip1.5mu \Varid{c2}\mskip1.5mu]\plus \Varid{s})){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mid \Varid{c1}\equiv \text{\tt '+'}\mathrel{\wedge}\Varid{c2}\equiv \text{\tt '('}\mathrel{=}\Conid{Just}\;(\Conid{Op}\;\text{\tt \char34 +\char34},(\Varid{a1},[\mskip1.5mu \Varid{c2}\mskip1.5mu]\plus \Varid{s})){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mid \Varid{otherwise}\mathrel{=}\Varid{testaPadrao}\;((\Varid{c2}\mathbin{:}\Varid{s}),(\Varid{a1}\plus [\mskip1.5mu \Varid{c1}\mskip1.5mu])){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{conquer}\mathbin{::}\Conid{Int}+(\Conid{Op},(\Conid{Codigo},\Conid{Codigo}))\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{conquer}\mathrel{=}\alt{\Varid{auxConq}}{\Varid{auxConquer}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxConq}\mathbin{::}\Conid{Int}\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{auxConq}\;\Varid{i}\mathrel{=}[\mskip1.5mu \text{\tt \char34 PUSH~\char34}\plus (\Varid{show}\;\Varid{i})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxConquer}\mathbin{::}(\Conid{Op},(\Conid{Codigo},\Conid{Codigo}))\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{auxConquer}\;((\Conid{Op}\;\text{\tt \char34 +\char34}),(\Varid{c1},\Varid{c2}))\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 ADD\char34}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxConquer}\;((\Conid{Op}\;\text{\tt \char34 -\char34}),(\Varid{c1},\Varid{c2}))\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 SUB\char34}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxConquer}\;((\Conid{Op}\;\text{\tt \char34 *\char34}),(\Varid{c1},\Varid{c2}))\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 MUL\char34}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxConquer}\;((\Conid{Op}\;\text{\tt \char34 /\char34}),(\Varid{c1},\Varid{c2}))\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 DIV\char34}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inL2D}\mathrel{=}\alt{\Conid{Unid}}{\uncurry{\uncurry{\Conid{Comp}}}\comp \Varid{assocl}}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{outL2D}\;(\Conid{Comp}\;\Varid{b}\;\Varid{a1}\;\Varid{a2})\mathrel{=}i_2\;(\Varid{b},(\Varid{a1},\Varid{a2})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recL2D}\;\Varid{h}\mathrel{=}\Varid{baseL2D}\;\Varid{id}\;\Varid{id}\;\Varid{h}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{collectLeafs}\;(\Conid{Comp}\;\Varid{b}\;\Varid{a1}\;\Varid{a2})\mathrel{=}\Varid{collectLeafs}\;\Varid{a1}\plus \Varid{collectLeafs}\;\Varid{a2}{}\<[E]%
\\[\blanklineskip]%
...
o cálculo da aproximação até \ensuremath{\Varid{i}\mathrel{=}\Varid{n}} da função cosseno $cos\ x
via série de Taylor:
\begin{eqnarray*}
	cos\ x = \sum_{i=0}^\infty \frac{(-1)^i}{(2i)!} x^{2i}
\end{eqnarray*}
Seja $c\ x\ n = \sum_{i=0}^{n} \frac{(-1)^i}{(2i)!} x^{2i}$ a função que dá essa aproximação.
É fácil de ver que \ensuremath{\Varid{c}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathrm{1}} e que $\ensuremath{\Varid{c}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \ensuremath{\Varid{c}\;\Varid{x}\;\Varid{n}} + \frac {(-1)^{n+1}} {(2(n+1))!} x^{2(n+1)}$.
Se definirmos $\ensuremath{\Varid{h}\;\Varid{x}\;\Varid{n}} = \frac {(-1)^{n+1}} {(2(n+1))!} x^{2(n+1)}$ teremos \ensuremath{\Varid{c}\;\Varid{x}} e \ensuremath{\Varid{h}\;\Varid{x}} em recursividade
mútua. Repetindo o processo para \ensuremath{\Varid{h}\;\Varid{x}\;\Varid{n}} é fácil de ver que $\ensuremath{\Varid{h}\;\Varid{x}\;\mathrm{0}} = \frac{-x^2}{2}$ e que
$\ensuremath{\Varid{h}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \ensuremath{\Varid{h}\;\Varid{x}\;\Varid{n}} * \frac {-x^{2}} {4n^2+14n+12}$ e, portanto, podemos definir $\ensuremath{\Varid{s}\;\Varid{n}} = {4n^2+14n+12}$.
Por último, e repetindo, mais uma vez, o processo para \ensuremath{\Varid{s}\;\Varid{n}} é fácil de ver que \ensuremath{\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{12}} e que
$\ensuremath{\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \ensuremath{\Varid{s}\;\Varid{n}} + {8n + 18}$ e, portanto, podemos definir $\ensuremath{\Varid{k}\;\Varid{n}} = {8n + 18}$, verificando-se \ensuremath{\Varid{k}\;\mathrm{0}\mathrel{=}\mathrm{18}}
e $\ensuremath{\Varid{k}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \ensuremath{\Varid{k}\;\Varid{n}} + 8 $. Daqui, obtemos no total quatro funções em recursividade mútua:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{c}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{c}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{c}\;\Varid{x}\;\Varid{n}\mathbin{+}\Varid{h}\;\Varid{x}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{h}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2}\mathbin{/}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{h}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2}\mathbin{/}(\Varid{s}\;\Varid{n})\mathbin{*}\Varid{h}\;\Varid{x}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{12}{}\<[E]%
\\
\>[B]{}\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{k}\;\Varid{n}\mathbin{+}\Varid{s}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{k}\;\mathrm{0}\mathrel{=}\mathrm{18}{}\<[E]%
\\
\>[B]{}\Varid{k}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{k}\;\Varid{n}\mathbin{+}\mathrm{8}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Segundo a \emph{regra de algibeira} descrita na página \ref{pg:regra} deste enunciado,
ter-se-á, de imediato:
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{loop}\;(\Varid{c},\Varid{h},\Varid{s},\Varid{k})\mathrel{=}(\Varid{c}\mathbin{+}\Varid{h},\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2}\mathbin{/}\Varid{s}\mathbin{*}\Varid{h},\Varid{s}\mathbin{+}\Varid{k},\Varid{k}\mathbin{+}\mathrm{8}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{init}\mathrel{=}(\mathrm{1},\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2}\mathbin{/}\mathrm{2},\mathrm{12},\mathrm{18}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{prj}\;(\Varid{c},\Varid{h},\Varid{s},\Varid{k})\mathrel{=}\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{check}\mathrel{=}\Varid{isUnique}\comp \Varid{idsToList}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{idsToList}\mathbin{::}\Conid{FS}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{idsToList}\mathrel{=}(\Varid{cataList}\;\alt{\Varid{nil}}{\uncurry{(\plus )}\comp ((\Varid{inList}\comp i_2\comp (\Varid{id}\times\alt{\Varid{nil}}{\Varid{idsToList}})\times\Varid{id}))})\comp \Varid{outFS}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isUnique}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{isUnique}\mathrel{=}\Varid{consumeBool}\comp \Varid{listBool}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{16}{}\<[16]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  cataFS :: ([(a, Either b c)] -> c) -> FS a b -> c}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tar}\mathbin{::}\Conid{FS}\;\Varid{a}\;\Varid{b}\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment tar = undefined}{}\<[E]%
\\
\>[B]{}\Varid{tar}\mathrel{=}\Varid{cataFS}\;(\Varid{concat}\comp \map \;(\Varid{auxTar}\comp (\Varid{id}\times\alt{\Varid{auxTar'}}{\Varid{id}}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment cataFS (concat . map (map (id><head).auxTar.(id >< (either auxTar' id))))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  ->>>>>cataFS (map (auxTar.(id >< (either auxTar' id))))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment tarAux :: [Either (a,b) [(Path a,b)]] -> [(Path a,b)]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment tarAux = map (either (singl><id) (collect' . concat . discollect))discollect ((l,b):t) = (map(\x -> (x,b)) l ): discollect t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment tarAux = map (either a b)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment tarAux = undefined}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment    a = singl >< id}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment    b = collect' . concat . discollect}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  mapTarAux :: (Eq b) => [(a,Either (a,b) [(Path a,b)])] -> [(Path a,b)]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  mapTarAux = concat . (map (tarAux.p2))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment tarAux :: [(a, Either String [(Path a,String)])] -> [(Path a,String)]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment tarAux = map (singl >< (either id ((cataList g) . map p2)))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     where g = either nil (uncurry (++))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxTar}\mathbin{::}(\Varid{a},[\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu])\to [\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxTar}\mathrel{=}((\lambda (\Varid{x},\Varid{y})\to (\Varid{cataList}\;\alt{\Varid{nil}}{\lambda ((\Varid{w},\Varid{v}),\Varid{l})\to ([\mskip1.5mu \Varid{x}\mskip1.5mu]\plus \Varid{w},\Varid{v})\mathbin{:}\Varid{l}}\;\Varid{y}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment auxTar :: [(a, [([a], b)])] -> [([a], b)]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment auxTar = map ((\(x,y) -> (foldr (\(w,v) acc -> ([x]++w,v)) ([],[]) y)))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxTar'}\mathbin{::}\Varid{b}\to [\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxTar'}\mathrel{=}\Varid{singl}\comp (\lambda \Varid{b}\to ([\mskip1.5mu \mskip1.5mu],\Varid{b})){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  tarAux :: (Eq b) => [(a,Either (a,b) [(Path a,b)])] -> [(Path a,b)]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  tarAux = concat . map ((either (singl . (singl >< id)) (collect' . concat . discollect)) . p2)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{collect'}\mathbin{::}(\Conid{Eq}\;\Varid{b})\Rightarrow [\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{collect'}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{collect'}\;((\Varid{a},\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}\mathbf{let}\;\Varid{lb}\mathrel{=}\Varid{filter}\;(\lambda (\Varid{x},\Varid{y})\to \Varid{y}\equiv \Varid{b})\;((\Varid{a},\Varid{b})\mathbin{:}\Varid{t}){}\<[E]%
\\
\>[B]{}\hsindent{26}{}\<[26]%
\>[26]{}\Varid{nb}\mathrel{=}\Varid{filter}\;(\lambda (\Varid{x},\Varid{y})\to \Varid{y}\not\equiv \Varid{b})\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{26}{}\<[26]%
\>[26]{}\mathbf{in}\;((\map \;\p1)\;\Varid{lb},\Varid{b})\mathbin{:}\Varid{collect'}\;\Varid{nb}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{discollect}\mathbin{::}[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]\to [\mskip1.5mu [\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{discollect}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{discollect}\;((\Varid{l},\Varid{b})\mathbin{:}\Varid{t})\mathrel{=}(\map \;(\lambda \Varid{x}\to (\Varid{x},\Varid{b}))\;\Varid{l})\mathbin{:}\Varid{discollect}\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
